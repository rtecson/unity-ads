...
NSString * const kUnityAdsVersion = @"1450";
...
- (NSString *)createCampaignQueryString:(BOOL)withInstalledApps {
  ...
  queryParams = [NSString stringWithFormat:@"%@&%@=%@", queryParams, kUnityAdsInitQueryParamNetworkKey, [self networks]];
